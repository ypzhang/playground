...
/* ------------------------------prototypes---------------------------- */ 
  int  mmdint(int, int*, int*, int*,int*, int*, int*, int*, int*);
  void mmdelm(int, int*, int*, int*, int*, int*, int*, int*, int*,int,int);
  void mmdupd(int, int, int*, int*, int, int*, int*, int*, int*,
	      int*, int*, int*, int,int*); 
  void mmdnum(int, int*, int*, int*); 
/*-----------------------------------------------------------------------*/
  ...
  *ncsub = 0;
  ...
  n500:
    ...
    *ncsub += mdeg + qsize[mdeg_node] - 2;
    ...
    mmdelm(mdeg_node, xadj, adjncy, head, invp, perm,
	   qsize, list, marker, maxint, tag);
...
void mmdelm(int mdeg_node, int *xadj, int *adjncy, int *head, int *forward,
	    int *backward, int *qsize, int *list, int *marker, int maxint,
	    int tag)
{
